...
module.exports = {
    ...
    async getDetalleUsuario(req, res, next) {
        try {
            idUsuario = req.params.idusuario;
            const data = await User.getDetalleUsuario(idUsuario);    
            console.log(`Usuarios: ${data}`);
            return res.status(201).json(data);
        } 
        catch (error) {
    ...
    async getRolUsuario(req, res, next) {
        try {
            idUsuario = req.params.idusuario;
            const data = await User.getRolUsuario(idUsuario);    
            console.log(`Usuarios: ${data}`);
            return res.status(201).json(data);
        } 
        catch (error) {
    ...
    async getSupervisor(req, res, next) {
        try {
            supervisor =req.params.supervisor;
            const data = await User.getSupervisor(supervisor);    
            console.log(`Usuarios: ${data}`);
            return res.status(201).json(data);
        } 
        catch (error) {
    ...
    async optenerSupervisores(req, res, next) {
        try {
            const data = await User.optenerSupervisores();    
            console.log(`Usuarios: ${data}`);
            return res.status(201).json(data);
        } 
        catch (error) {
    ...
    async optenerempleados(req, res, next) {
        try {
            const data = await User.optenerempleados();    
            console.log(`Usuarios: ${data}`);
            return res.status(201).json(data);
        } 
        catch (error) {
    ...
    async optenerdisenadores(req, res, next) {
        try {
            const data = await User.optenerDisenadores();    
            console.log(`Usuarios: ${data}`);
            return res.status(201).json(data);
        } 
        catch (error) {
    ...
    async login(req, res, next) {
        try {
            ...
            if (User.isPasswordMatched(password, myUser.password)) {
                ...
                console.log('USUARIO ENVIADO:', JSON.stringify(data, null, 2));
